 ...
 * @property {FailureProperties} [properties] - The error properties
 */
/**
...
/**
 * @typedef {(function(string): Failure) & (function(string, string | Error): Failure) & (function(string, Error, string): Failure) & (function(string, string, FailureProperties): Failure)} FailureFactory
 */

/**
 * @param {string} message - The error message
 * @param {string | Error | null} [cause] - The cause of the error or the error code
 * @param {string | Error | FailureProperties} [code] - The error code or the error properties
...
exports.failure = /** @type {FailureFactory} */ (failure);
